...
if __name__ == '__main__':
    ...
    #log_file = open(f"/data/inspur/wzr/TA-SQL/evaluation_log/{args.pred.split('/')[-2]}-{args.pred.split('/')[-1].split('.txt')[0]}-log.txt",'w')
    with open(f"/data/inspur/wzr/TA-SQL/evaluation_log/{args.predicted_sql_path.split('/')[-2]}-log.json", 'w', encoding='utf-8') as file:
        json.dump(exec_result, file, indent=4)
